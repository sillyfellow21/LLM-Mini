...
def send_verify_email(email: str, token: str):
    ...
    <div style="font-family:sans-serif;max-width:500px;margin:auto;padding:32px">
        ...
        <p>Click the button below to verify your MiniLLM account.</p>
    ...
    send_email(email, "Verify your MiniLLM account", html)
...
def send_reset_email(email: str, token: str):
    ...
    send_email(email, "Reset your MiniLLM password", html)
