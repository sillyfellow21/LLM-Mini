# ============================================================
# chat.py — MiniLLM Unified Chat Interface
# ============================================================
...
def main():
    parser = argparse.ArgumentParser(description="MiniLLM Chat Interface")
    ...
    print("\n" + "=" * 60)
    print("  🤖  MiniLLM — Multi-Personality AI")
    print("=" * 60)
